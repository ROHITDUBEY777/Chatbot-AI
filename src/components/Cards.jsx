    ...
    <motion.div
         ref={refcard}
          ...
          transition={{duration:1,ease:"easeOut"}}
           ...
           className='flex flex-col gap-34   justify-center   px-4  lg:flex-row md:gap-24   md:px-4 lg:px-24  min-h-screen     '>
       {cardsobj.map((item)=>(
         <div
         ...
         <ul className=' w-fit h-fit md:h-fit  justify-between items-center text-center  gap- '>
          ...
          <p className='rounded-lg  text-center py-4 md:px-6 xl:h-[24rem]  px-4 md:py-10  xl:px-12 bg-[#27272a]   text-base'>{item.description}</p>
         </ul>
         </div>
       ))}
